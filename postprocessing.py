...
shape_uri = 'COS'+os.sep+'COSnotwanted.shp'
shape_datasource = ogr.Open(shape_uri)
# #not wanted
aqLayer = shape_datasource.ExecuteSQL('SELECT *  FROM COSnotwanted WHERE COSN5 LIKE "1.%" OR COSN5 LIKE "2.%" OR COSN5 LIKE "3.1.1%"OR COSN5 LIKE "3.2.4.01%"OR COSN5 LIKE "3.2.4.02%" OR COSN5 LIKE "4.%" OR COSN5 LIKE "5.%"')
# #wanted
